...
public abstract class Chart<T extends ChartData<? extends IDataSet<? extends Entry>>> extends
    ...
    protected boolean isDrawHoriDescript = false;
    ...
    /**
     * returns true if drawing the horizonral bar is enabled when tapping on values
     * (use the setMarker(horizonral bar) method to specify a marker)
     *
     * @return
     */
    public boolean isDrawHoriDescript(){return isDrawHoriDescript;}
     ...
     * @param enabled
     */
    public void setDrawHoriDescript(boolean enabled){ isDrawHoriDescript = enabled;}
