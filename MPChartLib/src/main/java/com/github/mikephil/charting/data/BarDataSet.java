...
public class BarDataSet extends BarLineScatterCandleBubbleDataSet<BarEntry> implements IBarDataSet {
    ...
    /**
     * array of labels used to describe the different values of the horizontal bars
     */
    private String[] mHoriDescrip = new String[]{
            "HoriDescrip"
    };
    ...
    public void setmHoriDescrip(String[] labels) {
        mHoriDescrip = labels;
    }
